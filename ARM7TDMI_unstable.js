		...
		if (index < 0x200) {
			...
			switch ((index - 0xA00) >> 7) {
				case 0:
					...
					this.ARM32OPCODE[index] = this.performBranchPositive;
					break;
				case 1:
...
ARM7TDMI.prototype.performANDRegister = function (parentObj) {
	//AND Register
	parentObj.updateDataProcessingDestination(parentObj.getDataProcessingRegister() & parentObj.getDataProcessingRegister2());
};
ARM7TDMI.prototype.performANDImmediate = function (parentObj) {
	//AND Immediate
	parentObj.updateDataProcessingDestination(parentObj.getDataProcessingRegister() & parentObj.getDataProcessingImmediate());
};
ARM7TDMI.prototype.performANDSRegister = function (parentObj) {
	//ANDS Register
	parentObj.performBitwiseCPSRUpdate(parentObj.getDataProcessingRegister() & parentObj.getDataProcessingRegister2());
};
ARM7TDMI.prototype.performANDSImmediate = function (parentObj) {
	//ANDS Immediate
	parentObj.performBitwiseCPSRUpdate(parentObj.getDataProcessingRegister() & parentObj.getDataProcessingImmediate());
};
ARM7TDMI.prototype.performEORRegister = function (parentObj) {
	//EOR Register
	parentObj.updateDataProcessingDestination(parentObj.getDataProcessingRegister() ^ parentObj.getDataProcessingRegister2());
};
ARM7TDMI.prototype.performEORImmediate = function (parentObj) {
	//EOR Immediate
	parentObj.updateDataProcessingDestination(parentObj.getDataProcessingRegister() ^ parentObj.getDataProcessingImmediate());
};
ARM7TDMI.prototype.performEORSRegister = function (parentObj) {
	//EORS Register
	parentObj.performBitwiseCPSRUpdate(parentObj.getDataProcessingRegister() ^ parentObj.getDataProcessingRegister2());
};
ARM7TDMI.prototype.performEORSImmediate = function (parentObj) {
	//EORS Immediate
	parentObj.performBitwiseCPSRUpdate(parentObj.getDataProcessingRegister() ^ parentObj.getDataProcessingImmediate());
};
...
ARM7TDMI.prototype.getDataProcessingRegisterAndCarry = function () {
...
ARM7TDMI.prototype.performBitwiseCPSRUpdate = function (value) {
	...
	this.updateDataProcessingDestination(value);
}
ARM7TDMI.prototype.updateDataProcessingDestination = function (result) {
	this.registers[(this.instruction >> 12) & 0xF] = result;
}
