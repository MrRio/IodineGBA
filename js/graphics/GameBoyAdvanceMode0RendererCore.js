...
GameBoyAdvanceMode0Renderer.prototype.renderScanLine = function (line) {
	...
	if (this.gfx.displayObjectWindowFlag) {
		this.gfx.objWindowRenderer.renderScanLine(line, BG0Buffer, BG1Buffer, BG2Buffer, BG3Buffer, OBJBuffer);
	}
	if (this.gfx.displayWindow1Flag) {
		this.gfx.window1Renderer.renderScanLine(line, BG0Buffer, BG1Buffer, BG2Buffer, BG3Buffer, OBJBuffer);
	}
	if (this.gfx.displayWindow0Flag) {
		this.gfx.window0Renderer.renderScanLine(line, BG0Buffer, BG1Buffer, BG2Buffer, BG3Buffer, OBJBuffer);
	}
